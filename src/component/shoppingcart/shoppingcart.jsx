...
const ShoppingCart = ({ onIncrement, onDecrement, onDelete, books }) => {

  const cartBook = books.filter((element) => element.isInCart === true)
                        ...
                        {cartBook.map((book) => (
                          <tr>
                            <td class="align-middle d-flex bookImage">
                              <img className="rounded" src={book.url} width={40} alt="" />
                              <div className="p-2">
